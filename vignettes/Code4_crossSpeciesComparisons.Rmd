...
```{r rename clusters}
cellClasses <- c("3. L5 IT","2. L4* IT","1. L2/3 IT","4. L6 IT","8. NP","7. L6b","5. L5 CF","6. L6 CT")
...
Visualize the data in UMAP space.  **NOTE: The UMAP projection output using Windows (or other R/python configurations) may not agree with the UMAP projection shown here; however the cells assigned to each cluster (and thus all downstream analysis) will be identical.**  
